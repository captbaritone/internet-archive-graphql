...
import { GraphQLSchema, GraphQLObjectType, GraphQLList, GraphQLNonNull, GraphQLString, GraphQLInterfaceType, GraphQLBoolean, GraphQLInt, GraphQLInputObjectType } from "graphql";
export function getSchema(): GraphQLSchema {
    const ItemLikeType: GraphQLInterfaceType = new GraphQLInterfaceType({
        ...
        fields() {
            return {
                collections: {
                    description: "Collections to which this ItemLike belongs.",
                    name: "collections",
                ...
                files: {
                    description: "The files associated with this Item.",
                    name: "files",
                    type: new GraphQLList(new GraphQLNonNull(ItemFileType)),
                    args: {
                        includeMetadata: {
                            description: "Include files which are likely to be generated by the Internet Archive\nsuch as thumbnail images and XML/SQLite metadata files.",
                ...
                thumbnail: {
                    description: "The Item's thumbnail file image.",
                    name: "thumbnail",
                    type: ItemFileType
                },
                title: {
        ...
        fields() {
            return {
                ...
                files: {
                    ...
                    resolve(source, args) {
                        return source.files(args.includeMetadata);
                    }
                },
                identifier: {
                    description: "This identifier is a unique string naming the Item.",
    ...
    const CollectionType: GraphQLObjectType = new GraphQLObjectType({
        ...
        fields() {
            return {
                ...
                thumbnail: {
                    description: "The Collection's thumbnail file image.",
                    name: "thumbnail",
                    type: ItemFileType
                },
                title: {
